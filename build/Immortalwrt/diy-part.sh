...
# git clone https://github.com/Carseason/openwrt-tailscale package/openwrt-tailscale
...
export DNS_Settings="223.5.5.5 8.8.8.8"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
